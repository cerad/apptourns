<?php
namespace Cerad\Bundle\TournsBundle\Controller\Admin\PersonPlan;
...
{   
    ...
    {   
        ...
        return $this->redirect('cerad_tourn_admin_person_plans_list',array('slug' => $model['slug']));
    ...
    {   
        ...
        // The project
        $model['slug']    = $slug = $request->get('slug');
        $model['project'] = $project = $this->getProject($slug);
        if (!$project)
        {
